 ...
 */
public class StringTypeGeneratorTest {

    @Test
    public void testGenerateObjectValue() {
        StringTypeGenerator stringTypeGenerator = new StringTypeGenerator();
        Assert.assertEquals("12", stringTypeGenerator.generateObjectValue("12", null, false));
    ...
    public void testGenerateFieldObject() {
        ...
        Assert.assertEquals("12",
            stringTypeGenerator.generateFieldObject(String.class, null, "12\\n"));
