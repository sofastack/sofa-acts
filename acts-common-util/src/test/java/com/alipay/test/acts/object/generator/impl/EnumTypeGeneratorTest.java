...
public class EnumTypeGeneratorTest {
    ...
    public void testGenerateFieldObject() {
        ...
        Assert.assertEquals("RED", enumTypeGenerator.generateFieldObject(Color.class, null, "RED")
            .toString());
    ...
    public void testGenerateObjectValue() {
        ...
        EnumTypeGenerator enumTypeGenerator = new EnumTypeGenerator();
        Assert.assertEquals("RED", enumTypeGenerator.generateObjectValue("RED", null, false));
    ...
    public void testGetItemClass() {
        EnumTypeGenerator stringTypeGenerator = new EnumTypeGenerator();
