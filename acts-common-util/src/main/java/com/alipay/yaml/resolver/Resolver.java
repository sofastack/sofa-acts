 ...
 */
package com.alipay.yaml.resolver;
...
public class Resolver {
    ...
    public static final Pattern                   VALUE                 = Pattern
                                                                            .compile("^(?:=)$");
    public static final Pattern                   YAML                  = Pattern
                                                                            .compile("^(?:!|&|\\*)$");
