 ...
 */
package com.alipay.yaml.constructor;
...
import com.alipay.yaml.TypeDescription;
...
import com.alipay.yaml.util.ClassUtils;
import com.alipay.yaml.util.DefaultValues;
    ...
    protected class ConstructMapping implements Construct {
        ...
        protected Object createEmptyJavaBean(MappingNode node) {
            ...
            try {
                ...
                try {
                    java.lang.reflect.Constructor<?> defaultConstructor = type
                ...
                java.lang.reflect.Constructor<?>[] cS = type.getConstructors();

                if (cS == null || cS.length <= 0) {
                    throw new YAMLException("The current type" + type + "has no constructor");
                }

                java.lang.reflect.Constructor<?> c = cS[0];
                c.setAccessible(true);

                if (c.getParameterTypes().length == 0) {
                    result = c.newInstance();
                } else {
                    Object[] parameterList = new Object[c.getParameterTypes().length];
                    int i = 0;
                    for (Class<?> para : c.getParameterTypes()) {
                        if (ClassUtils.isPrimitiveOrWrapper(para)
                            || para.isAssignableFrom(String.class)) {
                            parameterList[i] = DefaultValues.defaultValue(para);
                        } else {
                    ...
                    result = c.newInstance(parameterList);
                }
            } catch (Exception e) {
        ...
        protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
            ...
            for (NodeTuple tuple : nodeValue) {
                ...
                try {
                    ...
                    if (memberDescription != null) {
                        switch (valueNode.getNodeId()) {
                            ...
                            case mapping:
                                ...
                                Class<? extends Object> keyType = memberDescription
                                    .getMapKeyType(key);
                                if (keyType != null) {
                    ...
                    // Correct when the property a String but the value is
                    // binary
    ...
    protected class ConstructScalar extends AbstractConstruct {
        ...
        public Object construct(Node nnode) {
            ...
            if (type.isPrimitive() || type == String.class || Number.class.isAssignableFrom(type)
                ...
                || type == Character.class || type == BigInteger.class || type == BigDecimal.class
        ...
        public Object construct(Node node) {
            ...
            if (Set.class.isAssignableFrom(node.getType())) {
                ...
                throw new YAMLException("No suitable constructor with "
                                        + String.valueOf(snode.getValue().size())
